...
public class ShutdownReciever extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        Utils.ErrorToFile("Context is ok - Se apago el dispositivo - " + Calendar.getInstance().getTime().toString());
        ...
        bundle.putString(AgenteDetalleFragment.ARG_TITLE, "Apagado de dispositivo");
        bundle.putString(AgenteDetalleFragment.ARG_MESSAGE, "El usuario " + Session.getUser().getFullName() + " ha apagado su dispositivo.");
