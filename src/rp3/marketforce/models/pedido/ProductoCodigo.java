...
public class ProductoCodigo  extends EntityBase<ProductoCodigo> {
    ...
    public static ProductoCodigo getProductoCodigo(DataBase db, String codigoExterno) {
        Cursor c = db.query(Contract.ProductoCodigo.TABLE_NAME, new String[]{Contract.ProductoCodigo._ID, Contract.ProductoCodigo.COLUMN_CODIGO_EXTERNO, Contract.ProductoCodigo.COLUMN_CODIGO}
