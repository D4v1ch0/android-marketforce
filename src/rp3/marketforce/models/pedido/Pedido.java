...
public class Pedido extends EntityBase<Pedido> {
    ...
    public Pedido getDocRef() {
        return docRef;
    }

    public void setDocRef(Pedido docRef) {
        this.docRef = docRef;
    }
    ...
    public boolean isTieneNotaCreditoRP3POS() {
        return tieneNotaCreditoRP3POS;
    }

    public void setTieneNotaCreditoRP3POS(boolean tieneNotaCreditoRP3POS) {
        this.tieneNotaCreditoRP3POS = tieneNotaCreditoRP3POS;
    }
    ...
    public static Pedido getPedidoCliente(DataBase db, long idcli) {
        Cursor c = db.query(Contract.Pedido.TABLE_NAME, new String[] {Contract.Pedido._ID, Contract.Pedido.COLUMN_ID_PEDIDO, Contract.Pedido.COLUMN_ID_AGENDA, Contract.Pedido.COLUMN_ID_AGENDA_INT,
                ...
                Contract.Pedido.COLUMN_TIPO_DOCUMENTO, Contract.Pedido.COLUMN_OBSERVACIONES, Contract.Pedido.COLUMN_TOTAL_DESCUENTOS, Contract.Pedido.COLUMN_TOTAL_IMPUESTOS, Contract.Pedido.COLUMN_SUBTOTAL,
                Contract.Pedido.COLUMN_SUBTOTAL_SIN_DESCUENTO, Contract.Pedido.COLUMN_REDONDEO, Contract.Pedido.COLUMN_EXCEDENTE, Contract.Pedido.COLUMN_BASE_IMPONIBLE, Contract.Pedido.COLUMN_BASE_IMPONIBLE_CERO}
                ,Contract.Pedido.COLUMN_ID_CLIENTE_INT + " = ? AND " + Contract.Pedido.COLUMN_ESTADO + " <> 'A'", new String[]{idcli + ""}, null,null, Contract.Pedido.COLUMN_FECHA_CREACION);
    ...
    public static Pedido getPedidoRepetido(DataBase db, String numeroDocumento, String tipoDocumento) {
        String query = QueryDir.getQuery( Contract.Pedido.QUERY_PEDIDOS_REPETIDO );
        Cursor c = null;

        c = db.rawQuery(query, new String[] {numeroDocumento, tipoDocumento});
    ...
    public static Pedido getPedidoByIdServer(DataBase db, int id) {
        String query = QueryDir.getQuery( Contract.Pedido.QUERY_PEDIDOS_BY_ID_SERVER );
        Cursor c = null;
