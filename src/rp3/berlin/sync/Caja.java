...
import rp3.berlin.models.pedido.Banco;
import rp3.berlin.models.pedido.ControlCaja;
import rp3.berlin.models.pedido.FormaPago;
import rp3.berlin.models.pedido.MarcaTarjeta;
import rp3.berlin.models.pedido.Tarjeta;
import rp3.berlin.models.pedido.TarjetaComision;
import rp3.berlin.models.pedido.TipoDiferido;
...
public class Caja {
    ...
    public static int executeSyncInsertControl(DataBase db, long idCaja){
        ...
        ControlCaja controlUpload = rp3.berlin.models.pedido.ControlCaja.getControlCaja(db, idCaja);
