...
import rp3.berlin.models.DiaNoLaboral;
        ...
        try {
            ...
            try {
                ...
                for (int i = 0; i < types.length(); i++) {
                    ...
                    DiaLaboral dia = new rp3.berlin.models.DiaLaboral();
                    ...
                    rp3.berlin.models.DiaLaboral.insert(db, dia);
                ...
                for (int i = 0; i < types.length(); i++) {
                    ...
                    JSONObject type = types.getJSONObject(i);
                    DiaNoLaboral dia = new rp3.berlin.models.DiaNoLaboral();
                    ...
                    rp3.berlin.models.DiaNoLaboral.insert(db, dia);
