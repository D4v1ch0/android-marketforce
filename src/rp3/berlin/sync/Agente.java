...
import rp3.berlin.models.AgenteResumen;
import rp3.berlin.models.AgenteUbicacion;
...
public class Agente {
    ...
    public static int executeSyncAgentes(DataBase db) {
        ...
        try {
            ...
            rp3.berlin.models.Agente.deleteAll(db, Contract.Agente.TABLE_NAME);

            for (int i = 0; i < types.length(); i++) {

                try {
                    JSONObject type = types.getJSONObject(i);
                    rp3.berlin.models.Agente agente = new rp3.berlin.models.Agente();
                    ...
                    rp3.berlin.models.Agente.insert(db, agente);
