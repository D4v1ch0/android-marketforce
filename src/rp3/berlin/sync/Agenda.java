...
public class Agenda {
    ...
    public static int executeSync(DataBase db, int idAgenda) {
        ...
        rp3.berlin.models.Agenda agendaUpload = rp3.berlin.models.Agenda.getAgendaUpload(db, idAgenda);
        ...
        try {
            ...
            if(agendaUpload.getIdCliente() == 0)
            {
                ...
                rp3.berlin.models.Cliente newCliente = rp3.berlin.models.Cliente.getClienteID(db, agendaUpload.get_idCliente(), false);
        ...
        try {
            ...
            try {
                ...
                rp3.berlin.models.Agenda.update(db, agendaUpload);
    ...
    public static int executeSyncGeolocation(DataBase db, int idAgenda, double latitud, double longitud) {
        ...
        rp3.berlin.models.Agenda agendaUpload = rp3.berlin.models.Agenda.getAgenda(db, idAgenda);
    ...
    public static int executeSyncInsert(DataBase db, long id_local) {
        ...
        rp3.berlin.models.Agenda agenda = rp3.berlin.models.Agenda.getAgenda(db, id_local);
        DecimalFormat df = new DecimalFormat("#.##");
        df.setRoundingMode(RoundingMode.CEILING);
        ...
        try {
            ...
            if(agenda.getIdCliente() == 0)
            {
                ...
                rp3.berlin.models.Cliente newCliente = rp3.berlin.models.Cliente.getClienteID(db, agenda.get_idCliente(), false);
                if(newCliente.getIdCliente() != 0)
                    jObject.put("IdCliente", newCliente.getIdCliente());
                else
                    return SyncAdapter.SYNC_EVENT_ERROR;
        ...
        try {
            ...
            try {
                ...
                for (int j = 0; j < agenda.getAgendaTareas().size(); j++) {
                    ...
                    rp3.berlin.models.AgendaTarea agendaTarea = agenda.getAgendaTareas().get(j);

                    agendaTarea.setIdAgenda(id);
                    agendaTarea.setEstadoTarea("P");
                    agendaTarea.setIdRuta(PreferenceManager.getInt(Contants.KEY_IDRUTA));

                    rp3.berlin.models.AgendaTarea.update(db, agendaTarea);
                }
    ...
    public static int executeSyncInserts(DataBase db) {
        ...
        List<rp3.berlin.models.Agenda> agendas = rp3.berlin.models.Agenda.getAgendaInserts(db);
        List<rp3.berlin.models.Agenda> agendasConId = new ArrayList<rp3.berlin.models.Agenda>();
        if (agendas.size() == 0)
            return SyncAdapter.SYNC_EVENT_SUCCESS;
        ...
        for (int i = 0; i < agendas.size(); i++) {
            rp3.berlin.models.Agenda agendaUpload = agendas.get(i);
            JSONObject jObject = new JSONObject();
            try {
                jObject.put("IdAgenda", agendaUpload.getIdAgenda());
        ...
        try {
            ...
            try {
                ...
                for (int i = 0; i < resp.length(); i++) {
                    ...
                    for (rp3.berlin.models.Agenda agdResp : agendas) {
                        if (agdResp.getID() == jObjResp.getInt("IdInterno")) {
                            ...
                            rp3.berlin.models.Agenda.update(db, agdResp);
        ...
        for (int i = 0; i < agendasConId.size(); i++) {
            rp3.berlin.models.Agenda agendaUpload = agendasConId.get(i);
    ...
    public static int executeSyncPendientes(DataBase db) {
        ...
        List<rp3.berlin.models.Agenda> agendas = rp3.berlin.models.Agenda.getAgendaPendientes(db);
        List<rp3.berlin.models.Agenda> agendasConId = new ArrayList<rp3.berlin.models.Agenda>();
        if (agendas.size() == 0)
            return SyncAdapter.SYNC_EVENT_SUCCESS;
        ...
        try {
            ...
            try {
                webService.invokeWebService();
                for (rp3.berlin.models.Agenda agd : agendas) {
                    agd.setEnviado(true);
