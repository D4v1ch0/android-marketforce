...
import rp3.berlin.models.oportunidad.*;
...
public class Oportunidad {
    public static int executeSyncInserts(DataBase db) {
        ...
        List<rp3.berlin.models.oportunidad.Oportunidad> oportunidades = rp3.berlin.models.oportunidad.Oportunidad.getOportunidadesInserts(db);
        ...
        for (int i = 0; i < oportunidades.size(); i++) {
            ...
            rp3.berlin.models.oportunidad.Oportunidad oportunidadUpload = oportunidades.get(i);
            ...
            try {
                ...
                rp3.berlin.models.oportunidad.Oportunidad.update(db, oportunidadUpload);
                for (OportunidadTarea agt : oportunidadUpload.getOportunidadTareas()) {
        ...
        for(rp3.berlin.models.oportunidad.Oportunidad opt : oportunidades) {
            for (int i = 0; i < opt.getOportunidadFotos().size(); i++) {
                ...
                try {
                    ...
                    try {
                        ...
                        rp3.berlin.models.oportunidad.OportunidadFoto.update(db, foto);
                    } catch (HttpResponseException e) {
                        if (e.getStatusCode() == HttpConnection.HTTP_STATUS_UNAUTHORIZED)
                            return SyncAdapter.SYNC_EVENT_AUTH_ERROR;
                        return SyncAdapter.SYNC_EVENT_HTTP_ERROR;
    ...
    public static int executeSyncPendientes(DataBase db) {
        ...
        List<rp3.berlin.models.oportunidad.Oportunidad> oportunidades = rp3.berlin.models.oportunidad.Oportunidad.getOportunidadesPendientes(db);
        if (oportunidades.size() == 0)
            return SyncAdapter.SYNC_EVENT_SUCCESS;
        ...
        for (int i = 0; i < oportunidades.size(); i++) {
            ...
            try {
                if (oportunidadUpload.getIdOportunidad() == 0) {
                    rp3.berlin.models.oportunidad.Oportunidad opt = rp3.berlin.models.oportunidad.Oportunidad.getOportunidadId(db, oportunidadUpload.get_idOportunidad());
                    if (opt.getIdOportunidad() != 0) {
                        oportunidadUpload.setIdOportunidad(opt.getIdOportunidad());
                        jObject.put("IdOportunidad", opt.getIdOportunidad());
                    } else {
                        Oportunidad.executeSyncInserts(db);
                        opt = rp3.berlin.models.oportunidad.Oportunidad.getOportunidadId(db, oportunidadUpload.get_idOportunidad());
                        if (opt.getIdOportunidad() != 0) {
                            oportunidadUpload.setIdOportunidad(opt.getIdOportunidad());
                            jObject.put("IdOportunidad", opt.getIdOportunidad());
                        } else
    ...
    public static int executeSync(DataBase db){
        ...
        try
        {
            ...
            fechaUlt.setTime(SyncAudit.getLastSyncDate(rp3.berlin.sync.SyncAdapter.SYNC_TYPE_UPLOAD_OPORTUNIDADES, SyncAdapter.SYNC_EVENT_SUCCESS));
            ...
            for(int i=0; i < types.length(); i++){
                ...
                try {
                    ...
                    rp3.berlin.models.oportunidad.Oportunidad.deleteOportunidadIdServer(db, type.getInt("IdOportunidad"));
                    ...
                    rp3.berlin.models.oportunidad.Oportunidad opt = rp3.berlin.models.oportunidad.Oportunidad.getOportunidadIdServer(db, type.getInt("IdOportunidad"));
                    if(opt.getID() != 0)
                        opt = rp3.berlin.models.oportunidad.Oportunidad.getOportunidadId(db, opt.getID());
                    ...
                    if(opt.getID() == 0)
                        rp3.berlin.models.oportunidad.Oportunidad.insert(db, opt);
                    else
                        rp3.berlin.models.oportunidad.Oportunidad.update(db, opt);
        ...
        return rp3.berlin.sync.SyncAdapter.SYNC_EVENT_SUCCESS;
    }
