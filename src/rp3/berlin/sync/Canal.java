...
public class Canal {
		...
		public static int executeSync(DataBase db){
			...
			{			
				...
				rp3.berlin.models.Canal.deleteAll(db, Contract.Canal.TABLE_NAME);
				...
				for(int i=0; i < types.length(); i++){
					try {
						...
						rp3.berlin.models.Canal cl = new rp3.berlin.models.Canal();
						cl.setID(type.getLong("IdCanal"));
						cl.setDescripcion(type.getString("Descripcion"));
					
						rp3.berlin.models.Canal.insert(db, cl);
