...
import rp3.berlin.content.EnviarUbicacionReceiver;
...
import rp3.berlin.models.oportunidad.OportunidadTareaActividad;
...
public class StartActivity extends rp3.app.StartActivity{
	...
	public void onContinue() {	
                ...
                !PreferenceManager.getString(Constants.KEY_LAST_PASS,"").equalsIgnoreCase(Session.getUser().getPassword()))
        {
            ...
            Oportunidad.deleteAll(getDataBase(), Contract.Oportunidad.TABLE_NAME);
            Oportunidad.OportunidadExt.deleteAll(getDataBase(), Contract.OportunidadExt.TABLE_NAME);
            OportunidadTipo.deleteAll(getDataBase(), Contract.OportunidadTipo.TABLE_NAME);
            OportunidadBitacora.deleteAll(getDataBase(), Contract.OportunidadBitacora.TABLE_NAME);
            OportunidadResponsable.deleteAll(getDataBase(), Contract.OportunidadResponsable.TABLE_NAME);
            OportunidadEtapa.deleteAll(getDataBase(), Contract.OportunidadEtapa.TABLE_NAME);
            OportunidadContacto.deleteAll(getDataBase(), Contract.OportunidadContacto.TABLE_NAME);
            OportunidadFoto.deleteAll(getDataBase(), Contract.OportunidadFoto.TABLE_NAME);
            OportunidadTarea.deleteAll(getDataBase(), Contract.OportunidadTarea.TABLE_NAME);
            OportunidadTareaActividad.deleteAll(getDataBase(), Contract.OportunidadTareaActividad.TABLE_NAME);
            AgendaOportunidad.deleteAll(getDataBase(), Contract.AgendaOportunidad.TABLE_NAME);
            AgendaOportunidad.AgendaOportunidadExt.deleteAll(getDataBase(), Contract.AgendaOportunidadExt.TABLE_NAME);
