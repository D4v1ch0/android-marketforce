...
import rp3.berlin.DateDisplayPicker;
import rp3.berlin.R;
import rp3.berlin.models.Cliente;
import rp3.berlin.models.ClienteDireccion;
import rp3.berlin.sync.ClienteActualizacion;
		...
		if (client != null) {
			...
			if (savedInstanceState == null) {
				...
				setSpinnerAdapter(R.id.spinner_state_civil,
						new rp3.content.SimpleGeneralValueAdapter(this.getActivity(), getDataBase(), rp3.berlin.Contants.GENERAL_TABLE_ESTADO_CIVIL));
