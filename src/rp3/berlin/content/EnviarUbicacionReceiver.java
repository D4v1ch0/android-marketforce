...
public class EnviarUbicacionReceiver extends BroadcastReceiver    {
	...
	public void onReceive(final Context context, Intent intent) {			
		...
		try
		{
            ...
            DiaLaboral diaLaboral = DiaLaboral.getDia(DataBase.newDataBase(rp3.berlin.db.DbOpenHelper.class), Utils.getDayOfWeek(calendarCurrent));
			if(context == null)
							...
							if(location!=null){
                                if(Session.IsLogged()) {
                                    if (ConnectionUtils.isNetAvailable(context)) {
                                        ...
                                        Ubicacion.insert(DataBase.newDataBase(rp3.berlin.db.DbOpenHelper.class), ub);
