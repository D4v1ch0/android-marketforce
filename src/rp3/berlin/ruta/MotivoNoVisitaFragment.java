...
import rp3.berlin.ruta.ContactsAgendaFragment.SaveContactsListener;
...
public class MotivoNoVisitaFragment extends BaseFragment {
	...
	public void onFragmentCreateView(final View rootView, Bundle savedInstanceState) {
		...
		SimpleGeneralValueAdapter motivosNoVisitaAdapter= new SimpleGeneralValueAdapter(getContext(), getDataBase(), rp3.berlin.Contants.GENERAL_TABLE_MOTIVOS_NO_VISITA);
