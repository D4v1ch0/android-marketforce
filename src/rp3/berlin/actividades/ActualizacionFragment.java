...
public class ActualizacionFragment extends BaseFragment {
    ...
    public void onFragmentCreateView(View rootView, Bundle savedInstanceState) {
        ...
        SimpleGeneralValueAdapter tipoEstadoCivilAdapter = new SimpleGeneralValueAdapter(getContext(), getDataBase(), rp3.berlin.Contants.GENERAL_TABLE_ESTADO_CIVIL);
        SimpleGeneralValueAdapter tipoGeneroAdapter = new SimpleGeneralValueAdapter(getContext(), getDataBase(), rp3.berlin.Contants.GENERAL_TABLE_GENERO);
