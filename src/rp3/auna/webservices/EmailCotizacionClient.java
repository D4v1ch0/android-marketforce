...
public class EmailCotizacionClient {
    private static final String TAG = EmailCotizacionClient.class.getSimpleName();
    private static final MediaType MEDIA_TYPE_JPEG = MediaType.parse("application/json");
    private String resource = "ventanueva/SendEmailCotizacion/";
    private Context context;
    private Callback callBack;

    public EmailCotizacionClient(Context context,Callback callback){
