...
public class UpdateVisitaClient {
    private static final String TAG = UpdateVisitaClient.class.getSimpleName();
    private static final MediaType MEDIA_TYPE_JPEG = MediaType.parse("application/json");
    private String resource = "llamada/actualizarvisita";
    private Context context;
    private Callback callBack;

    public UpdateVisitaClient(Context context, Callback callback){
