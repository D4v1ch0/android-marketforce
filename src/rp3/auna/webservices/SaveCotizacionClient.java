...
/**
 * Created by Jesus Villa on 30/10/2017.
 */

public class SaveCotizacionClient {
        private static final String TAG = SaveCotizacionClient.class.getSimpleName();
        private static final MediaType MEDIA_TYPE_JPEG = MediaType.parse("application/json");
        private String resource = "ventanueva/savecotizacion";
        private Context context;
        private Callback callBack;

        public SaveCotizacionClient(Context context,Callback callback){
