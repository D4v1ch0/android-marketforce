...
public class EmailAfiliacionProcesoClient {
    private static final String TAG = EmailAfiliacionProcesoClient.class.getSimpleName();
    private static final MediaType MEDIA_TYPE_JPEG = MediaType.parse("application/json");
    private String resource = "ventanueva/SendEmailAfiliacionProceso/";
    private Context context;
    private Callback callBack;

    public EmailAfiliacionProcesoClient(Context context,Callback callback){
