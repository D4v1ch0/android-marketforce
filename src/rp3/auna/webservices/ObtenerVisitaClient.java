...
public class ObtenerVisitaClient {
    private static final String TAG = ObtenerVisitaClient.class.getSimpleName();
    private String resource = "agendavta/GetVisitas";
    private Context context;
    private Callback callBack;

    public ObtenerVisitaClient(Context context,Callback callback){
