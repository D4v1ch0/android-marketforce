...
public class ValidarAfiliadoClient {
    private static final String TAG = ValidarAfiliadoClient.class.getSimpleName();
    private static final MediaType MEDIA_TYPE_JPEG = MediaType.parse("application/json");
    private String resource = "ventanueva/ValidarAfiliado";
    private Context context;
    private Callback callBack;

    public ValidarAfiliadoClient(Context context, Callback callback){
