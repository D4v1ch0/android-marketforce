...
import rp3.auna.DateDisplayPicker;
import rp3.auna.R;
import rp3.auna.models.Cliente;
import rp3.auna.models.ClienteDireccion;
import rp3.auna.sync.ClienteActualizacion;
		...
		if (client != null) {
			...
			if (savedInstanceState == null) {
				...
				setSpinnerAdapter(R.id.spinner_state_civil,
						new rp3.content.SimpleGeneralValueAdapter(this.getActivity(), getDataBase(), rp3.auna.Contants.GENERAL_TABLE_ESTADO_CIVIL));
