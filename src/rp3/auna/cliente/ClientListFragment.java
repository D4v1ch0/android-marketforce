...
import rp3.auna.R;
import rp3.auna.headerlistview.HeaderListView;
import rp3.auna.loader.ClientLoader;
...
public class ClientListFragment extends rp3.app.BaseFragment {
    ...
    private List<rp3.auna.models.Cliente> lista;
    private ArrayList<ArrayList<rp3.auna.models.Cliente>> list_order;
...
//    	executeLoader(0, b, this);
	...
	private void OrderBy(int option) {
        ...
        try {
            ...
            list_order = new ArrayList<ArrayList<rp3.auna.models.Cliente>>();
            ...
            switch (option) {
                ...
                case ORDER_BY_NAME:
                    ...
                    for (int x = 0; x < headersortList.size(); x++) {
                        ArrayList<rp3.auna.models.Cliente> list_aux = new ArrayList<rp3.auna.models.Cliente>();

                        for (int y = 0; y < lista.size(); y++) {
                            if (headersortList.get(x).equals("" + lista.get(y).getNombre1().toUpperCase().charAt(0))) {
                                rp3.auna.models.Cliente cliente = new rp3.auna.models.Cliente();
...
//			ORDER_IDENTIFICATOR	= ORDER_BY_LAST_NAME;
        ...
        {
            Log.d(TAG,"Exception Order by:"+ex.getMessage());
        }
    ...
    public class LoaderCliente implements LoaderCallbacks<List<Cliente>>{
		...
		{								
			lista = data;
            Log.d(TAG,"onLoadFinished Cantidad de clientes:"+lista.size());
			OrderBy(ORDER_BY_NAME);
