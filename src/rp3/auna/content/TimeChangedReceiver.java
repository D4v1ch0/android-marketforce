...
public class TimeChangedReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        //NotificationPusher.pushNotification(1, context, "El usuario " + Session.getUserMovil().getFullName() + " ha cambiado la hora de su dispositivo. Auto-Time: " + perc, "Cambio de hora");
