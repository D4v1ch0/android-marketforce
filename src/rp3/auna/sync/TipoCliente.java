...
public class TipoCliente {
		...
		public static int executeSync(DataBase db){
			...
			{			
				...
				rp3.auna.models.TipoCliente.deleteAll(db, Contract.TipoCliente.TABLE_NAME);
				...
				for(int i=0; i < types.length(); i++){
					...
					try {
						...
						rp3.auna.models.TipoCliente tcl = new rp3.auna.models.TipoCliente();
						tcl.setID(type.getLong("IdTipoCliente"));
						tcl.setDescripcion(type.getString("Descripcion"));
					
						rp3.auna.models.TipoCliente.insert(db, tcl);
