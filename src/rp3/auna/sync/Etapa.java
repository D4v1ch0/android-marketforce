...
import rp3.auna.models.oportunidad.EtapaTarea;
...
public class Etapa {
    public static int executeSync(DataBase db){
        ...
        try
        {
            ...
            rp3.auna.models.oportunidad.Etapa.deleteAll(db, Contract.Etapa.TABLE_NAME);
            ...
            for(int i=0; i < types.length(); i++){
                ...
                try {
                    ...
                    rp3.auna.models.oportunidad.Etapa etapa = new rp3.auna.models.oportunidad.Etapa();
                    ...
                    rp3.auna.models.oportunidad.Etapa.insert(db, etapa);
    ...
    public static int executeSyncTipos(DataBase db){
        ...
        try
        {
            ...
            rp3.auna.models.oportunidad.OportunidadTipo.deleteAll(db, Contract.OportunidadTipo.TABLE_NAME);

            for(int i=0; i < types.length(); i++){

                try {
                    JSONObject type = types.getJSONObject(i);
                    rp3.auna.models.oportunidad.OportunidadTipo optTipo = new rp3.auna.models.oportunidad.OportunidadTipo();

                    optTipo.setIdOportunidadTipo(type.getInt("IdOportunidadTipo"));
                    optTipo.setDescripcion(type.getString("Descripcion"));

                    rp3.auna.models.oportunidad.OportunidadTipo.insert(db, optTipo);
