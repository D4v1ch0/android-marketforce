...
import rp3.auna.models.DiaNoLaboral;
        ...
        try {
            ...
            try {
                ...
                for (int i = 0; i < types.length(); i++) {
                    ...
                    DiaLaboral dia = new rp3.auna.models.DiaLaboral();
                    ...
                    rp3.auna.models.DiaLaboral.insert(db, dia);
                ...
                for (int i = 0; i < types.length(); i++) {
                    ...
                    JSONObject type = types.getJSONObject(i);
                    DiaNoLaboral dia = new rp3.auna.models.DiaNoLaboral();
                    ...
                    rp3.auna.models.DiaNoLaboral.insert(db, dia);
