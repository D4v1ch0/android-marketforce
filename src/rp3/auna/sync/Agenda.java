...
public class Agenda {
    ...
    public static int executeSync(DataBase db, int idAgenda) {
        ...
        rp3.auna.models.Agenda agendaUpload = rp3.auna.models.Agenda.getAgendaUpload(db, idAgenda);
        ...
        try {
            ...
            try {
                ...
                rp3.auna.models.Agenda.update(db, agendaUpload);
    ...
    public static int executeSyncGeolocation(DataBase db, int idAgenda, double latitud, double longitud) {
        ...
        rp3.auna.models.Agenda agendaUpload = rp3.auna.models.Agenda.getAgenda(db, idAgenda);
    ...
    public static int executeSyncInserts(DataBase db) {
        ...
        List<rp3.auna.models.Agenda> agendasConId = new ArrayList<rp3.auna.models.Agenda>();
        if (agendas.size() == 0)
            return SyncAdapter.SYNC_EVENT_SUCCESS;

        JSONArray jArray = new JSONArray();
        for (int i = 0; i < agendas.size(); i++) {
            rp3.auna.models.Agenda agendaUpload = agendas.get(i);
            JSONObject jObject = new JSONObject();
            try {
                jObject.put("IdAgenda", agendaUpload.getIdAgenda());
        ...
        try {
            ...
            try {
                ...
                for (int i = 0; i < resp.length(); i++) {
                    ...
                    for (rp3.auna.models.Agenda agdResp : agendas) {
                        if (agdResp.getID() == jObjResp.getInt("IdInterno")) {
                            ...
                            rp3.auna.models.Agenda.update(db, agdResp);
                            //rp3.auna.models.Agenda.delete(db, agdResp);
        ...
        for (int i = 0; i < agendasConId.size(); i++) {
            rp3.auna.models.Agenda agendaUpload = agendasConId.get(i);
    ...
    public static int executeSyncPendientes(DataBase db) {
        ...
        try {
            ...
            try {
                webService.invokeWebService();
                for (rp3.auna.models.Agenda agd : agendas) {
                    agd.setEnviado(true);
