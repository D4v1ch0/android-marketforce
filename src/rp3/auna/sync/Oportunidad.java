...
import rp3.auna.models.oportunidad.*;
...
public class Oportunidad {
    public static int executeSyncInserts(DataBase db) {
        ...
        List<rp3.auna.models.oportunidad.Oportunidad> oportunidades = rp3.auna.models.oportunidad.Oportunidad.getOportunidadesInserts(db);
        ...
        for (int i = 0; i < oportunidades.size(); i++) {
            ...
            rp3.auna.models.oportunidad.Oportunidad oportunidadUpload = oportunidades.get(i);
            ...
            try {
                ...
                rp3.auna.models.oportunidad.Oportunidad.update(db, oportunidadUpload);
                for (OportunidadTarea agt : oportunidadUpload.getOportunidadTareas()) {
        ...
        for(rp3.auna.models.oportunidad.Oportunidad opt : oportunidades) {
            for (int i = 0; i < opt.getOportunidadFotos().size(); i++) {
                ...
                try {
                    ...
                    try {
                        ...
                        rp3.auna.models.oportunidad.OportunidadFoto.update(db, foto);
                    } catch (HttpResponseException e) {
                        if (e.getStatusCode() == HttpConnection.HTTP_STATUS_UNAUTHORIZED)
                            return SyncAdapter.SYNC_EVENT_AUTH_ERROR;
                        return SyncAdapter.SYNC_EVENT_HTTP_ERROR;
    ...
    public static int executeSyncPendientes(DataBase db) {
        ...
        List<rp3.auna.models.oportunidad.Oportunidad> oportunidades = rp3.auna.models.oportunidad.Oportunidad.getOportunidadesPendientes(db);
        if (oportunidades.size() == 0)
            return SyncAdapter.SYNC_EVENT_SUCCESS;
    ...
    public static int executeSync(DataBase db){
        ...
        try
        {
            ...
            fechaUlt.setTime(SyncAudit.getLastSyncDate(rp3.auna.sync.SyncAdapter.SYNC_TYPE_UPLOAD_OPORTUNIDADES, SyncAdapter.SYNC_EVENT_SUCCESS));
            ...
            //rp3.auna.models.oportunidad.Oportunidad.deleteAll(db, Contract.Oportunidad.TABLE_NAME);
            ...
            for(int i=0; i < types.length(); i++){
                ...
                try {
                    ...
                    rp3.auna.models.oportunidad.Oportunidad.deleteOportunidadIdServer(db, type.getInt("IdOportunidad"));
                    ...
                    rp3.auna.models.oportunidad.Oportunidad opt = rp3.auna.models.oportunidad.Oportunidad.getOportunidadIdServer(db, type.getInt("IdOportunidad"));
                    if(opt.getID() != 0)
                        opt = rp3.auna.models.oportunidad.Oportunidad.getOportunidadId(db, opt.getID());
                    ...
                    if(opt.getID() == 0)
                        rp3.auna.models.oportunidad.Oportunidad.insert(db, opt);
                    else
                        rp3.auna.models.oportunidad.Oportunidad.update(db, opt);
